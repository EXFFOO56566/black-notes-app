...
public final class v {
    ...
    private static Method f246a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f246a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    private static float a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f246a) != null) {
            try {

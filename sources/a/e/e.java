...
public class e<K, V> {
    ...
    private final LinkedHashMap<K, V> f83a;
    ...
    public e(int i) {
        if (i > 0) {
            this.f85c = i;
            this.f83a = new LinkedHashMap<>(0, 0.75f, true);
            return;
        }
    ...
    public final V b(K r5) {
        /*
            ...
            monitor-enter(r4)
            java.util.LinkedHashMap<K, V> r0 = r4.f83a     // Catch:{ all -> 0x0051 }
        ...
        L_0x0022:
            ...
            java.util.LinkedHashMap<K, V> r1 = r4.f83a     // Catch:{ all -> 0x004e }
            java.lang.Object r1 = r1.put(r5, r0)     // Catch:{ all -> 0x004e }
            if (r1 == 0) goto L_0x0037
            java.util.LinkedHashMap<K, V> r2 = r4.f83a     // Catch:{ all -> 0x004e }
            r2.put(r5, r1)     // Catch:{ all -> 0x004e }
            goto L_0x0040
        L_0x0037:
            int r2 = r4.f84b     // Catch:{ all -> 0x004e }
            int r3 = r4.c(r5, r0)     // Catch:{ all -> 0x004e }
            int r2 = r2 + r3
            r4.f84b = r2     // Catch:{ all -> 0x004e }
        L_0x0040:
        ...
        L_0x0054:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: a.e.e.b(java.lang.Object):java.lang.Object");
    }

    public final synchronized String toString() {
        int i;
        i = this.g + this.h;
        return String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", Integer.valueOf(this.f85c), Integer.valueOf(this.g), Integer.valueOf(this.h), Integer.valueOf(i != 0 ? (this.g * 100) / i : 0));
    }
}

...
class q0 extends c implements View.OnClickListener {
    ...
    public static final class a {
        ...
        public final ImageView f686c;
        public final ImageView d;
        public final ImageView e;

        public a(View view) {
            this.f684a = (TextView) view.findViewById(16908308);
            this.f685b = (TextView) view.findViewById(16908309);
            this.f686c = (ImageView) view.findViewById(16908295);
    ...
    private Drawable b(String str) {
        ...
        try {
            ...
            Drawable c2 = a.g.d.a.c(this.o, parseInt);
            a(str2, c2);
            return c2;
    ...
    private CharSequence b(CharSequence charSequence) {
        if (this.t == null) {
            ...
            this.e.getTheme().resolveAttribute(a.a.a.textColorSearchUrl, typedValue, true);
    ...
    private Drawable d(Cursor cursor) {
        ...
        return b2 != null ? b2 : this.e.getPackageManager().getDefaultActivityIcon();
    }
    ...
    public void a(View view, Context context, Cursor cursor) {
        ...
        if (aVar.f684a != null) {
            a(aVar.f684a, a(cursor, this.u));
        }
        if (aVar.f685b != null) {
            String a2 = a(cursor, this.w);
            CharSequence b2 = a2 != null ? b((CharSequence) a2) : a(cursor, this.v);
            if (TextUtils.isEmpty(b2)) {
                TextView textView = aVar.f684a;
                if (textView != null) {
                    textView.setSingleLine(false);
                    aVar.f684a.setMaxLines(2);
                }
            } else {
                TextView textView2 = aVar.f684a;
                if (textView2 != null) {
                    textView2.setSingleLine(true);
                    aVar.f684a.setMaxLines(1);
                }
            }
            a(aVar.f685b, b2);
        }
        ImageView imageView = aVar.f686c;
        if (imageView != null) {
        ...
        if (i3 == 2 || (i3 == 1 && (i2 & 1) != 0)) {
            ...
            aVar.e.setTag(aVar.f684a.getText());
    ...
    public View getDropDownView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            if (a2 != null) {
                ((a) a2.getTag()).f684a.setText(e.toString());
            }
            return a2;
        }
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            if (b2 != null) {
                ((a) b2.getTag()).f684a.setText(e.toString());
            }
            return b2;
        }
    }

...
public abstract class a implements View.OnTouchListener {
    ...
    final C0044a f808b = new C0044a();

    /* renamed from: c  reason: collision with root package name */
    private final Interpolator f809c = new AccelerateInterpolator();
    final View d;
    private Runnable e;
    ...
    public static class C0044a {
        ...
        private float a(long j2) {
            ...
            long j3 = this.i;
            if (j3 < 0 || j2 < j3) {
                return a.a(((float) (j2 - this.e)) / ((float) this.f810a), 0.0f, 1.0f) * 0.5f;
            }
            long j4 = j2 - j3;
            float f2 = this.j;
        ...
        public void g() {
            long currentAnimationTimeMillis = AnimationUtils.currentAnimationTimeMillis();
            this.k = a.a((int) (currentAnimationTimeMillis - this.e), 0, this.f811b);
    ...
    private float a(float f2, float f3, float f4, float f5) {
        ...
        if (f7 < 0.0f) {
            f6 = -this.f809c.getInterpolation(-f7);
        } else if (f7 <= 0.0f) {
            return 0.0f;
        } else {
            f6 = this.f809c.getInterpolation(f7);
    ...
    public boolean onTouch(android.view.View r6, android.view.MotionEvent r7) {
        ...
        L_0x001e:
            ...
            androidx.core.widget.a$a r7 = r5.f808b
            r7.a(r0, r6)
            boolean r6 = r5.p

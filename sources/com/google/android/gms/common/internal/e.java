...
public final class e {
    ...
    private static final g<String, String> f1621a = new g<>();
    ...
    private static String a(Context context, String str) {
        synchronized (f1621a) {
            String str2 = f1621a.get(str);
            if (str2 != null) {
                return str2;
            }
            Resources c2 = i.c(context);
            if (c2 == null) {
                return null;
            }
    ...
    private static String a(Context context, String str, String str2) {
        ...
        if (a2 == null) {
            a2 = resources.getString(l.common_google_play_services_unknown_issue);
        }
            ...
            if (i == 3) {
                ...
                if (i == 9) {
                    ...
                    switch (i) {
                        ...
                        default:
                            return resources.getString(l.common_google_play_services_unknown_issue, a2);
                    }
                }
            }
        } else if (h.d(context)) {

...
.method static constructor <clinit>()V
    ...
    sget v2, Lb/c/b/b/b;->colorPrimary:I
    ...
    sget v2, Lb/c/b/b/b;->colorPrimaryVariant:I
    ...
    sget v1, Lb/c/b/b/b;->materialThemeOverlay:I
...
.method private static a(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    sget-object v0, Lb/c/b/b/k;->ThemeEnforcement:[I

    invoke-virtual {p0, p1, v0, p2, p3}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Lb/c/b/b/k;->ThemeEnforcement_enforceMaterialTheme:I
    ...
    sget p3, Lb/c/b/b/b;->isMaterialTheme:I
    ...
    :cond_0
    invoke-static {p0}, Lcom/google/android/material/internal/g;->b(Landroid/content/Context;)V
...
.method private static varargs a(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)V
    ...
    sget v1, Lb/c/b/b/k;->ThemeEnforcement_enforceTextAppearance:I
    ...
    :cond_1
    invoke-static/range {p0 .. p5}, Lcom/google/android/material/internal/g;->b(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Z
    ...
    :cond_2
    :goto_0
    sget p0, Lb/c/b/b/k;->ThemeEnforcement_android_textAppearance:I
...
.method private static a(Landroid/content/Context;[ILjava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lcom/google/android/material/internal/g;->a(Landroid/content/Context;[I)Z
...
.method public static b(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    invoke-static {p0, p1, p2, p3}, Lcom/google/android/material/internal/g;->c(Landroid/content/Context;Landroid/util/AttributeSet;II)I

    move-result p2

    if-eqz p2, :cond_2

    instance-of p3, p0, La/a/n/d;

    if-eqz p3, :cond_0

    move-object p3, p0

    check-cast p3, La/a/n/d;

    invoke-virtual {p3}, La/a/n/d;->a()I
    ...
    :cond_0
    new-instance p3, La/a/n/d;

    invoke-direct {p3, p0, p2}, La/a/n/d;-><init>(Landroid/content/Context;I)V

    invoke-static {p3, p1}, Lcom/google/android/material/internal/g;->a(Landroid/content/Context;Landroid/util/AttributeSet;)I
    ...
    invoke-direct {p1, p3, p0}, La/a/n/d;-><init>(Landroid/content/Context;I)V
...
.method public static varargs d(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroidx/appcompat/widget/w0;
    .locals 0
    ...
    invoke-static {p0, p1, p2, p3, p4}, Landroidx/appcompat/widget/w0;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/w0;

...
.method public static declared-synchronized a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v1, p0, p1}, Landroidx/appcompat/widget/m0$c;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v2, p0, p1, v1}, Landroidx/appcompat/widget/m0$c;->a(ILandroid/graphics/PorterDuff$Mode;Landroid/graphics/PorterDuffColorFilter;)Landroid/graphics/PorterDuffColorFilter;
    :try_end_0
...
.method private static a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;[I)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-static {p0, p1}, Landroidx/appcompat/widget/m0;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method private a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/m0;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/m0;->a(I)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-interface {v0, p1, p2, p4}, Landroidx/appcompat/widget/m0$e;->b(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    :cond_2
    invoke-virtual {p0, p1, p2, p4}, Landroidx/appcompat/widget/m0;->a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
...
.method private declared-synchronized a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0, p2, p3}, La/e/d;->b(J)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_2
    invoke-virtual {v0, p2, p3}, La/e/d;->a(J)V
    :try_end_2
...
.method public static declared-synchronized a()Landroidx/appcompat/widget/m0;
    .locals 2
    ...
    invoke-static {v1}, Landroidx/appcompat/widget/m0;->a(Landroidx/appcompat/widget/m0;)V
...
.method private a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    :cond_1
    invoke-virtual {v0, p2, p3}, La/e/h;->a(ILjava/lang/Object;)V

    return-void
.end method

.method static a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/u0;[I)V
    .locals 2
    ...
    :goto_2
    invoke-static {v0, p1, p2}, Landroidx/appcompat/widget/m0;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;[I)Landroid/graphics/PorterDuffColorFilter;
...
.method private static a(Landroidx/appcompat/widget/m0;)V
    .locals 2
...
.method private a(Ljava/lang/String;Landroidx/appcompat/widget/m0$d;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/m0;->b:La/e/a;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/m0;->b:La/e/a;
...
.method private declared-synchronized a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, p1}, La/e/d;->c(JLjava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private b(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/m0;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-static {p1}, Landroidx/appcompat/widget/m0;->a(Landroid/graphics/drawable/Drawable;)Z
...
.method private c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0}, Landroidx/appcompat/widget/m0;->a(Landroid/util/TypedValue;)J

    move-result-wide v1

    invoke-direct {p0, p1, v1, v2}, Landroidx/appcompat/widget/m0;->a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, v1, v2, p2}, Landroidx/appcompat/widget/m0;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
...
.method private d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, p2}, La/e/h;->a(I)Ljava/lang/Object;
...
.method private e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, La/e/g;->isEmpty()Z

    move-result v0

    if-nez v0, :cond_a

    iget-object v0, p0, Landroidx/appcompat/widget/m0;->c:La/e/h;

    const-string v2, "appcompat_skip_skip"

    if-eqz v0, :cond_1

    invoke-virtual {v0, p2}, La/e/h;->a(I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/m0;->b:La/e/a;

    invoke-virtual {v3, v0}, La/e/g;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/m0;->c:La/e/h;
    ...
    invoke-direct {p0, p1, v4, v5}, Landroidx/appcompat/widget/m0;->a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/m0;->c:La/e/h;

    invoke-virtual {v8, p2, v3}, La/e/h;->a(ILjava/lang/Object;)V

    iget-object v8, p0, Landroidx/appcompat/widget/m0;->b:La/e/a;

    invoke-virtual {v8, v3}, La/e/g;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, v4, v5, v6}, Landroidx/appcompat/widget/m0;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/m0;->c:La/e/h;

    invoke-virtual {p1, p2, v2}, La/e/h;->a(ILjava/lang/Object;)V
...
.method a(I)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_0
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/m0$e;->a(I)Landroid/graphics/PorterDuff$Mode;
...
.method public declared-synchronized a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, v0}, Landroidx/appcompat/widget/m0;->a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/m0;->b(Landroid/content/Context;)V

    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/m0;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/m0;->c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, p2}, La/g/d/a;->c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Landroidx/appcompat/widget/m0;->a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized a(Landroid/content/Context;Landroidx/appcompat/widget/b1;I)Landroid/graphics/drawable/Drawable;
    .locals 1

    monitor-enter p0

    :try_start_0
    invoke-direct {p0, p1, p3}, Landroidx/appcompat/widget/m0;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p3, p2, v0}, Landroidx/appcompat/widget/m0;->a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public declared-synchronized a(Landroidx/appcompat/widget/m0$e;)V
    .locals 0
...
.method declared-synchronized b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/m0;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-interface {v0, p1, p2}, Landroidx/appcompat/widget/m0$e;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1, p2, v0}, Landroidx/appcompat/widget/m0;->a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

...
.method private a(IIII)I
    ...
    iget-object p2, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->h:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/RecyclerView$c0;->a(F)F
...
.method public run()V
    ...
    invoke-virtual {v4}, Landroidx/recyclerview/widget/RecyclerView$z;->d()Z
    ...
    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView$a0;->a()I

    move-result v9

    if-nez v9, :cond_3

    invoke-virtual {v4}, Landroidx/recyclerview/widget/RecyclerView$z;->h()V

    goto :goto_0

    :cond_3
    invoke-virtual {v4}, Landroidx/recyclerview/widget/RecyclerView$z;->c()I
    ...
    invoke-virtual {v4, v9}, Landroidx/recyclerview/widget/RecyclerView$z;->c(I)V

    :cond_4
    invoke-virtual {v4, v8, v7}, Landroidx/recyclerview/widget/RecyclerView$z;->a(II)V
    ...
    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView$z;->d()Z
    ...
    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$z;->d()Z

    move-result v4

    if-eqz v4, :cond_18

    invoke-virtual {v1, v2, v2}, Landroidx/recyclerview/widget/RecyclerView$z;->a(II)V
